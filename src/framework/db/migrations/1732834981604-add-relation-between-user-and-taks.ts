...
export class AddRelationBetweenUserAndTaks1732834981604
  implements MigrationInterface
{
  name = "AddRelationBetweenUserAndTaks1732834981604";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "tasks" DROP COLUMN "user_id"`);
    await queryRunner.query(`ALTER TABLE "tasks" ADD "user_id" uuid NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "tasks" DROP COLUMN "user_id"`);
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD "user_id" character varying NOT NULL`
    );
  }
}
